...
--REU.RES_CODIGO,
CASE
WHEN RES.RES_RESPUESTA = '' AND REU.REU_OTRO IS NOT NULL THEN FOT.FOT_RUTA
...
INNER JOIN SIM_RESPUESTA_USUARIO AS REU ON REU.RUT_CODIGO=RUT.RUT_CODIGO AND REU.ESTADO=1
