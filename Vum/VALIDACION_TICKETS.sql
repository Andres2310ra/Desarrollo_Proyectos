...
FROM
(VALUES('42822',	'ACOMPAÑAMIENTOS',	'BD',	'1',	'4',	'6',	'1'),
...
MONTH(TIK.FECHA_CREACION) AS MES_SOLICITUD,
DATEPART(WEEK, TIK.FECHA_CREACION) - DATEPART(WEEK, DATEADD(MONTH, DATEDIFF(MONTH, 0, TIK.FECHA_CREACION), 0)) + 1 AS SEMANA_MES_SOLICITUD,
...
FORMAT(TIK.FECHA_CREACION, 'HH:mm:ss') AS HORA_SOLICITUD,
UPPER(FORMAT(CONVERT(DATE, TIK.FECHA_CREACION), 'dddd', 'es-ES')) AS DIA_SEMANA_SOLICITUD,
CONVERT(DATE,IIF(SOL2.FECHA_CREACION IS NULL,TTK.FECHA_CREACION,SOL2.FECHA_CREACION)) AS FECHA_ASIGNACION,
FORMAT(IIF(SOL2.FECHA_CREACION IS NULL,TTK.FECHA_CREACION,SOL2.FECHA_CREACION), 'HH:mm:ss') AS HORA_ASIGNACION,
...
FORMAT(TTK.FECHA_CREACION, 'HH:mm:ss') AS HORA_RESPUESTA,
UPPER(FORMAT(CONVERT(DATE, TTK.FECHA_CREACION), 'dddd', 'es-ES')) AS DIA_SEMANA_RESPUESTA,
--TTK.FECHA_CREACION ,TIK.FECHA_CREACION,
DATEDIFF(DAY,TIK.FECHA_CREACION,TTK.FECHA_CREACION) AS DIAS_TRANSCURIDOS,

CASE
    WHEN CONVERT(DATE, TIK.FECHA_CREACION) = CONVERT(DATE, TTK.FECHA_CREACION) 
    THEN 0
    
    WHEN UPPER(FORMAT(CONVERT(DATE, TIK.FECHA_CREACION), 'dddd', 'es-ES')) = 'VIERNES' 
         AND UPPER(FORMAT(CONVERT(DATE, TTK.FECHA_CREACION), 'dddd', 'es-ES')) = 'SÁBADO' 
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION) 
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION))     
    
    WHEN CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) >= 10
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) - 4  
    
    WHEN UPPER(FORMAT(CONVERT(DATE, TIK.FECHA_CREACION), 'dddd', 'es-ES')) = 'VIERNES' 
         AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) >= 2
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION) 
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) - 2
    
     WHEN UPPER(FORMAT(CONVERT(DATE, TIK.FECHA_CREACION), 'dddd', 'es-ES')) = 'SÁBADO' 
         AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) >= 1
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION) 
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) - 1
    
     WHEN UPPER(FORMAT(CONVERT(DATE, TIK.FECHA_CREACION), 'dddd', 'es-ES')) = 'DOMINGO' 
         AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) >= 1
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION) 
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION))      
    
    WHEN (DATEPART(WEEKDAY, TIK.FECHA_CREACION) = 2 AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) <= 7)
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) <= 6
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) 
    
    WHEN (DATEPART(WEEKDAY, TIK.FECHA_CREACION) = 3 AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) <= 7)
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) <= 5
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) 
    
    WHEN (DATEPART(WEEKDAY, TIK.FECHA_CREACION) = 4 AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) <= 7)
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) <= 4
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION))
    
    WHEN (DATEPART(WEEKDAY, TIK.FECHA_CREACION) = 5 AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) <= 7)
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) <= 3
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION))
    
    WHEN (DATEPART(WEEKDAY, TIK.FECHA_CREACION) = 6 AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) <= 7)
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) <= 2
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) 
    
    WHEN (DATEPART(WEEKDAY, TIK.FECHA_CREACION) = 7 AND DATEPART(WEEKDAY, TTK.FECHA_CREACION) <= 7)
         AND CONVERT(DATE, TIK.FECHA_CREACION) < CONVERT(DATE, TTK.FECHA_CREACION)
         AND DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) <= 1
    THEN DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION))
    ...
    ELSE DATEDIFF(DAY, CONVERT(DATE, TIK.FECHA_CREACION), CONVERT(DATE, TTK.FECHA_CREACION)) - 2          
    
END AS DIAS_HABILES_TRANSCURIDOS,
...
END<=NVL.NIVEL_REQUERIMIENTO,'TICKET EN TIEMPOS','TICKET FUERA DE TIEMPOS') AS ESTADO_EJECUCION,
